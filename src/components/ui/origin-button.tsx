    ...
    return (
      <motion.button
        ...
        className={cn(
          ...
          showFill && "text-[#f8f3ec] dark:text-[#171412]",
          className,
        )}
      ...
      >
        <motion.span
          ...
          aria-hidden
          className="pointer-events-none absolute -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#1f1916] dark:bg-[#f5efe8]"
          initial={false}
          style={{
            height: coverSize,
            left: origin.x,
        ...
        <span
          className={cn(
            ...
            showFill ? "text-[#f8f3ec]" : "text-[#1d1d1d]",
          )}
        >
          {children}
        </span>
